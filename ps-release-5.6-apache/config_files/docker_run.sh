...
#Get sourcecode
wget  https://download.prestashop.com/download/releases/prestashop_$PS_VERSION.zip -P /tmp
unzip /tmp/prestashop_$PS_VERSION.zip -d /tmp
...
if [ ! -f ./config/settings.inc.php  ]; then
	...
	# init if empty
	cp -n -R /tmp/prestashop/* /var/www/html
	...
	mv /var/www/html/$PS_FOLDER_INSTALL/ /var/www/html/install_bk
