#  Dockerized for PrestaShop with Prestashop 1.7.x and develop branch in Prestashop's SCM 
[ Prestashop's SCM ](https://github.com/PrestaShop/PrestaShop)

### Install which Prestashop version you need

Open the docker-compose.yml in ps1.7-dev-5.6-apache folder, change the value of PS_VERSION to the version you need (ex: 1.7.4.2)
...
```
$ docker run -ti --name my-docker-name -e PS_DEV_MODE=false -e PS_INSTALL_AUTO=0 -p 8080:80 -d biolinh/prestashop-base:ps1.7-dev
```
### Apache versions
